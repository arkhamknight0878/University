...
//    table_size = 1000;
//    main_area_size = 200;
//    next_in_alt_table = 201;
//
//    initialize_table();
//}
//
//string_hash::~string_hash() { delete[] hash_table; }
//
...
//
//int string_hash::find(int key_)
//{
//    int hash_index = hash_function(key_);
//
//    while (hash_table[hash_index].token_value != key_)
//    {
//        if (hash_table[hash_index].alt != key_)
//            hash_index = hash_table[hash_index].alt;
//        else
//            return -1;
//    }
